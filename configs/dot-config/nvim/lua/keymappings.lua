...
maps.normal_mode["<leader>pi"] = {
  function()
    require("lazy").install()
  end,
  desc = "Plugins Install",
}
maps.normal_mode["<leader>ps"] = {
  function()
    require("lazy").home()
  end,
  desc = "Plugins Status",
...
maps.normal_mode["<leader>gp"] = {
  function()
    require("gitsigns").preview_hunk()
  end,
  desc = "Preview Git hunk",
}
maps.normal_mode["<leader>gh"] = {
  function()
    require("gitsigns").reset_hunk()
  end,
  desc = "Reset Git hunk",
}
maps.normal_mode["<leader>gr"] = {
  function()
    require("gitsigns").reset_buffer()
  end,
  desc = "Reset Git buffer",
}
maps.normal_mode["<leader>gs"] = {
  function()
...
maps.normal_mode["<leader>gu"] = {
  function()
    require("gitsigns").undo_stage_hunk()
  end,
  desc = "Unstage Git hunk",
}
maps.normal_mode["<leader>gd"] = {
  function()
...
if vim.env.KITTY_WINDOW_ID then
  maps.normal_mode["<C-h>"] = {
    function()
      kitty.navigateLeft()
    end,
    desc = "Move to left split",
  }
  maps.normal_mode["<C-j>"] = {
    function()
      kitty.navigateDown()
    end,
    desc = "Move to below split",
  }
  maps.normal_mode["<C-k>"] = {
    function()
      kitty.navigateUp()
    end,
    desc = "Move to above split",
  }
  maps.normal_mode["<C-l>"] = {
    function()
      kitty.navigateRight()
    end,
...
maps.normal_mode["<leader>sb"] = {
  function()
    require("telescope.builtin").buffers()
  end,
  desc = "Find buffers",
}
maps.normal_mode["<leader>sc"] = {
  function()
...
maps.normal_mode["<leader>sh"] = {
  function()
    require("telescope.builtin").help_tags()
  end,
  desc = "Find help",
}
maps.normal_mode["<leader>sk"] = {
  function()
    require("telescope.builtin").keymaps()
  end,
  desc = "Find keymaps",
}
maps.normal_mode["<leader>sm"] = {
  function()
    require("telescope.builtin").man_pages()
  end,
  desc = "Find man",
}
maps.normal_mode["<leader>so"] = {
  function()
    require("telescope.builtin").oldfiles()
  end,
  desc = "Find history",
}
maps.normal_mode["<leader>sr"] = {
  function()
...
if vim.fn.executable("lazydocker") == 1 then
  maps.normal_mode["<leader>td"] = {
    function()
      terminal.toggle_term_cmd("lazydocker")
    end,
...
if vim.fn.executable("node") == 1 then
  maps.normal_mode["<leader>tn"] = {
    function()
      terminal.toggle_term_cmd("node")
    end,
    desc = "ToggleTerm node",
  }
end
if vim.fn.executable("gdu") == 1 then
  maps.normal_mode["<leader>tu"] = {
    function()
      terminal.toggle_term_cmd("gdu")
    end,
    desc = "ToggleTerm gdu",
  }
end
if vim.fn.executable("btm") == 1 then
  maps.normal_mode["<leader>tt"] = {
    function()
      terminal.toggle_term_cmd("btm")
    end,
    desc = "ToggleTerm btm",
  }
end
...
maps.normal_mode["<F10>"] = {
  function()
    require("dap").step_over()
  end,
  desc = "Debugger: Step Over",
}
maps.normal_mode["<F11>"] = {
  function()
    require("dap").step_into()
  end,
  desc = "Debugger: Step Into",
}
maps.normal_mode["<F23>"] = {
  function()
    require("dap").step_out()
  end,
  desc = "Debugger: Step Out",
} -- Shift+F11
maps.normal_mode["<leader>db"] = {
  function()
    require("dap").toggle_breakpoint()
  end,
...
maps.normal_mode["<leader>di"] = {
  function()
    require("dap").step_into()
  end,
  desc = "Step Into (F11)",
}
maps.normal_mode["<leader>do"] = {
  function()
    require("dap").step_over()
  end,
  desc = "Step Over (F10)",
...
maps.normal_mode["<leader>dp"] = {
  function()
    require("dap").pause()
  end,
  desc = "Pause (F6)",
}
maps.normal_mode["<leader>dr"] = {
  function()
    require("dap").restart_frame()
  end,
  desc = "Restart (C-F5)",
...
maps.normal_mode["<leader>ds"] = {
  function()
    require("dap").run_to_cursor()
  end,
  desc = "Run To Cursor",
}
maps.normal_mode["<leader>da"] = {
  function()
...
maps.visual_mode["<leader>de"] = {
  function()
    require("dapui").eval()
  end,
  desc = "Evaluate Input (F2)",
}
maps.normal_mode["<leader>du"] = {
  function()
    require("dapui").toggle()
  end,
  desc = "Toggle Debugger UI",
}
maps.normal_mode["<leader>dh"] = {
  function()
